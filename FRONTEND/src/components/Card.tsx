const Card = ({img, types,title, content} : {img: string, types: string, title: string, content: string}) => {
  return (
    <div className="shadow-sm rounded-xl w-76 gap-2 overflow-hidden h-96">
      ...
      <div className="p-4">
        ...
        <button className="mt-5 bg-blue-600 text-white py-2 px-5 cursor-pointer hover:bg-blue-500 rounded-lg w-full font-semibold text-sm">View Applications</button>
      </div>
    </div>
  )
}
